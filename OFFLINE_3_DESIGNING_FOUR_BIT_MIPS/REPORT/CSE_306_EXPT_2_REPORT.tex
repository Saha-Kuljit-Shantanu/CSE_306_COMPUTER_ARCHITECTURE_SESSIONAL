...
\subsubsection{ALU Control}
    ...
    \begin{tikzpicture}
        ...
        \node (in2) [io, below of = dec,yshift = -3cm]{3 bit ALUOP};
        \node (enc) [sblock, below of =in2, yshift = -3cm] {3*8 Priority Encoder};
        \node (in3) [io, below of =enc, yshift = -3cm]{ALU Control Signal};
